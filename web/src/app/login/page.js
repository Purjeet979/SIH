          ...
          <div className="auth-form-wrapper">
            ...
            <div style={{
              ...
              <div style={{display: 'flex', gap: '8px', flexWrap: 'wrap'}}>
                <button
                  type="button"
                  onClick={() => setDemoAccount('officer@rulescan.gov.in', 'officer123')}
                  style={{
                    flex: '1 1 140px',
                    padding: '8px 10px',
                    borderRadius: '8px',
                    border: '1px solid ' + (email === 'officer@rulescan.gov.in' ? '#2563eb' : 'var(--line, #cbd5e1)'),
                    background: email === 'officer@rulescan.gov.in' ? '#eff6ff' : 'var(--surface, #fff)',
                    cursor: 'pointer',
                    textAlign: 'left',
                ...
                >
                  ...
                  <div style={{fontSize: '10.5px', color: 'var(--text-muted, #64748b)'}}>officer@rulescan.gov.in</div>
                  <div style={{fontSize: '10px', color: '#2563eb', fontWeight: '600'}}>Pass: officer123</div>
                </button>
                <button
                  type="button"
                  onClick={() => setDemoAccount('admin@rulescan.gov.in', 'admin123')}
                  style={{
                    flex: '1 1 140px',
                    padding: '8px 10px',
                    borderRadius: '8px',
                    border: '1px solid ' + (email === 'admin@rulescan.gov.in' ? '#8b5cf6' : 'var(--line, #cbd5e1)'),
                    background: email === 'admin@rulescan.gov.in' ? '#f5f3ff' : 'var(--surface, #fff)',
                    cursor: 'pointer',
                    textAlign: 'left',
                    transition: 'all 0.15s ease'
                  }}
                >
                  ...
                  <div style={{fontSize: '10.5px', color: 'var(--text-muted, #64748b)'}}>admin@rulescan.gov.in</div>
